...
class BlogController extends Controller
{
    ...
    {
        $data = dia_diem::all();
        return view('admin.list_baiviet', compact('data'));
    }

    public function show_add_baiviet()
    {
        return view('admin.add_baiviet');
    }

    public function add_baiviet(Request $request)
    {
        ...
        $model = new dia_diem();
        $model->tieu_de = $validatedData['TieuDe'];
    ...
    {
        $diadiem = dia_diem::findOrFail($ma_dia_diem);
        return view('admin.edit_baiviet', compact('baiviet'));
    }

    public function delete_blog($ma_dia_diem)
    {
        $location = dia_diem::findOrFail($ma_dia_diem);
        $location->delete();
        return redirect()->route('list_baiviet')->with('success', 'Địa điểm đã được xóa thành công!');
    }
    public function store(Request $request)
    {
        ...
        return redirect()->route('list_baiviet')->with('success', 'Dữ liệu đã được lưu thành công.');
    }
}
